...
public class IntroManager : MonoBehaviour {
	...
	void Start () {
		...
		boldonVOToggle = GameObject.Find ("BoldonVOToggle").GetComponent<Toggle> ();
	...
	public void NextScreen() {
		if (pageState == 0) {
			...
			playerPrefs.boldonVO = boldonVOToggle.isOn;
